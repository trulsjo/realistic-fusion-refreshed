...
from this repository at **`fa53c6b` with uncommitted changes**.
...
| pass | the map is stopped from fighting back, so a long run measures the reactor | pollution and expansion off, peaceful, 11 enemy entities removed |
