...
**It does not settle how a known-red lane is recorded.** Seventeen lanes have run and **seven** stand
red as of 2026-09-23 (the three Realistic Fusion Power Port lanes, #450 to #452, are all red on
upstream assets), after falling from eight to four on 2026-09-02 when
